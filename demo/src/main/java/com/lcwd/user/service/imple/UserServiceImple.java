...
import com.lcwd.user.service.external.HotelServices;
...
//	private Logger logger = (Logger) LoggerFactory.getLogger(UserServiceImple.class);
	...
	public User getUser(String userId) {
		...
		User user = userRepository.findById(userId)
				.orElseThrow(() -> new ResouceNotFound("userId doesnot found" + userId));

		Rating[] ratingsOfUsers = restTemplate.getForObject("http://RATINGSERVICE/ratings/users/" + user.getUserId(),
				Rating[].class);
